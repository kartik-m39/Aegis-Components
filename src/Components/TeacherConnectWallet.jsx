...
import TeacherUplaod from "./TeacherUpload";
...
function TeacherConnectWallet() {
  ...
  return (
    <>
      ...
      {!isconnected ? (
        <button onClick={connectWallet} className="w-full py-2 px-4 bg-purple-500 text-white font-medium rounded-md border-2 border-green-400 hover:bg-purple-600 hover:border-green-300 transition-all duration-300 shadow-md hover:shadow-green-500/30 disabled:opacity-50">Connect Wallet</button>
      ) : (
...
export default TeacherConnectWallet;
